...
end_100 = -1
psd_x = np.concatenate([cip_15["x"][start_15:end_15], cip_100["x"][start_100:end_100]])
psd_y = np.concatenate(
...
end_100 = -1
psd_x_s = np.concatenate(
    [cip_15_s["x"][start_15:end_15], cip_100_s["x"][start_100:end_100]]
)
psd_y_s = np.concatenate(
    [cip_15_s["dndd"][start_15:end_15], cip_100_s["dndd"][start_100:end_100]]
)
