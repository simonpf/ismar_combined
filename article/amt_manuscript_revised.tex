...
\begin{abstract}
  ...
  to validate the retrieval and assess its capabilities to constrain the
  ...
  calibration or the modeling of gas absorption. For one of the flights the
  quality of the fit to the observations exhibits a weak dependency on the
  assumed ice particle shape, indicating that the employed combination of
  observations may provide limited information on the shape of ice particles in
  ...
  observations may improve remote-sensing measurements of ice hydrometeors and
...
\begin{figure}[h!]
  \centering \includegraphics[width=1.0\textwidth]{figs/fig01}
...
\begin{figure}[hbpt!]
  \centering
  \includegraphics[width=0.8\textwidth]{figs/fig02}
...
\begin{figure}[hbpt!]
  \centering
  \includegraphics[width=0.6\textwidth]{figs/fig03}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=1.0\textwidth]{figs/fig04}
  \caption{
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=1.0\textwidth]{figs/fig05}
  \caption{
...
\begin{figure}[hbpt!]
  \centering
  \includegraphics[width=0.9\textwidth]{figs/fig08}
...
\begin{figure}[!hbpt]
  \centering
  \includegraphics[width=0.95\textwidth]{figs/fig10}
...
\begin{figure}[!hbpt]
  \centering
  \includegraphics[width=0.8\textwidth]{figs/fig11}
...
\begin{figure}[!hbpt]
  \centering
  \includegraphics[width=1.0\textwidth]{figs/fig15}
  \caption{
...
%Another interesting aspect of these results is the selection of channels in
%which indications of a signal from the particle shape are present: These are
%channels with a comparably high atmospheric transmission, which means that they
%are sensitive to the lower parts of the cloud. Our interpretation is that this
%is likely due to the structure of the observed clouds, which have sufficiently
%large ice particles for their shape to have a significant impact of the passive
%observations only at their base. There may thus be a difference in which
%channels contribute to the synergy between radar and passive sub-millimeter
%observations for mid-latitude cloud systems compared to deep convective cloud
%systems more likely to be found in the (sub-)tropics. While deep convective
%systems may have sufficiently large particles aloft for a significant signal in
%the frequencies 
...
\begin{figure}
  \centering
  \includegraphics[width=1.0\textwidth]{figs/fig18}
  \caption{
